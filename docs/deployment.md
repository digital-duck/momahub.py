# Momahub Deployment & Operations Guide
...
Momahub follows the **Signal / Docker Hub model**:
...
**Why:** Overkill for Momahub, but free is free. Runs indefinitely.
...
| **Momahub** | Open source (Apache 2.0) | Project maintainer | hub.momahub.org |

Momahub sits closest to the **Signal/Docker Hub model**: open source code,
